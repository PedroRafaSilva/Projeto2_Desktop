...
import Controller.Agendamento.AgendamentoEditarController;
...
public class ExtraEditarController {
    ...
    public void openVerificarAgend() throws IOException {
        ...
        agendamentoEditarController.getData(agendamentoService.getAgendamentoById(idAgendamento));
        stage.show();
    }
